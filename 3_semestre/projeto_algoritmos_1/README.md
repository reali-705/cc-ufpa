...
### 1. [Angry Birds Replica](./angry_birds/)

Uma implementação progressiva focada em **Programação Orientada a Objetos (POO)** e interface gráfica rudimentar com HTML5 Canvas/DOM.

- **Destaques:** Evolução de scripts simples para classes herdeiras (Personagem, Porco, Pássaro), uso de diagramas UML e algoritmos de ordenação para ranking de pontuação.
- **Tecnologias:** TypeScript, JavaScript, PlantUML.

### 2. [No Man's Sky: Estruturas de Dados](./no_man_sky/)

O projeto final da disciplina, focado na implementação **do zero** de estruturas fundamentais para um motor de exploração espacial.
